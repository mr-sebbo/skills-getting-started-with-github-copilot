...
activities = {
    ...
    # Artistic activities
    "Art Club": {
        "description": "Studio time for painting, drawing, and mixed media",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["mia@mergington.edu", "amelia@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Chamber and ensemble rehearsals for various instruments",
    ...
    "Science Club": {
        ...
        "max_participants": 24,
        "participants": ["elijah@mergington.edu", "jackson@mergington.edu"]
    }
}
